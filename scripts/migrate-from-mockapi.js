...
async function migrateUsers() {
    ...
    for (const mu of mockUsers) {
        ...
        // Original parol xavfsiz emas edi (plaintext) - shuning uchun uni
        // qayta ishlatib xavf yaratmaslik uchun tasodifiy vaqtinchalik parol
        // bilan almashtiramiz. Foydalanuvchi buni keyin tiklashi kerak.
        ...
        console.log(`[migrate] yaratildi: ${email} (${TEMP_PASSWORD_NOTE})`);
    }
...
async function main() {
    ...
    console.log("\n[migrate] Tugadi.");
    console.log(TEMP_PASSWORD_NOTE);
